<?php
$dsn = 'mysql:dbname=gfg0dm52o2ou4r6l;host=klbcedmmqp7w17ik.cbetxkdyhwsb.us-east-1.rds.amazonaws.com;charset=utf8mb4';
$user = 'upusizbdpayvu5tt';
$password = 'dorh3ga6qq79rjyf';


// submitパラメータの値が存在するとき（更新ボタンを押下時）の処理
if(isset($_POST['submit'])) {
  try {
    ...
    // 商品一覧ページをリダイレクトさせる（同時にmessageパラメータを渡す）
...
if(isset($_GET['id'])) {
  try {
    ...
    // vendorsテーブルからvendor_codeカラムのデータを取得するためのSQL文の変数$sql_select_vendor_codesに代入する
